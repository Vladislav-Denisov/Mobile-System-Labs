...
Page {
    ...
    Column {
        ...
        Button {
            ...
            onClicked: {
                var dialog = pageStack.push(Qt.resolvedUrl("task03_dialog.qml"));
        ...
        Button {
            ...
            onClicked: {
                var dialog = pageStack.push(Qt.resolvedUrl("task04_dialog.qml"));
                dialog.accepted.connect(function() {
        ...
        Button {
            ...
            onClicked: {
                var dialog = pageStack.push(Qt.resolvedUrl("task05_dialog.qml"));
                dialog.accepted.connect(function() {
